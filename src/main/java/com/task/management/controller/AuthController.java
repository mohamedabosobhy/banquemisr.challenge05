...
public class AuthController {
    ...
    @PostMapping("/login")
    public String login(@RequestBody AuthRequest authRequest) throws TaskManagementException {
        ...
        return jwtTokenUtil.generateToken(authRequest.getUsername(),claims);
    }
